...
The form of the table is equivalent to that of the wage tables. However, only those individuals who were employed for three consective quarters, beginning with the exit quarter, are considered _stably employed_ and are in this table and therefore contribute to the aggregate statistics. 
